...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-sky-ba4c
```

A live public deployment of this template is available at [https://nameless-sky-ba4c.templates.workers.dev](https://nameless-sky-ba4c.templates.workers.dev)
